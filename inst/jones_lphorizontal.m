...
## -*- texinfo -*-
## @deftypefn  {Function File} {@var{V} =} jones_lphorizontal()
## @deftypefnx {Function File} {@var{V} =} jones_lphorizontal(@var{p})
...
%! % test return value
%! amplitude = rand(1, 1);
%! V = jones_lphorizontal(amplitude);
%! R = V-[1;0]*amplitude;
%! assert(norm(R,inf), 0, 1e-9);
%!
%!test
