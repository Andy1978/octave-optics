...
## -*- texinfo -*-
## @deftypefn  {Function File} {@var{V} =} stokes_lphorizontal()
## @deftypefnx {Function File} {@var{V} =} stokes_lphorizontal(@var{p})
...
%! % test return value
%! intensity = rand(1, 1);
%! V = stokes_lphorizontal(intensity);
%! R = V-[1;1;0;0]*intensity;
%! assert(norm(R,inf), 0, 1e-9);
%!
%!test
