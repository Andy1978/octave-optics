...
## -*- texinfo -*-
## @deftypefn  {Function File} {@var{V} =} stokes_lpvertical()
## @deftypefnx {Function File} {@var{V} =} stokes_lpvertical(@var{p})
