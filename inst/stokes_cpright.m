...
## -*- texinfo -*-
## @deftypefn  {Function File} {@var{V} =} stokes_cpright()
## @deftypefnx {Function File} {@var{V} =} stokes_cpright(@var{p})
...
%! % test return value
%! intensity = rand(1, 1);
%! V = stokes_cpright(intensity);
%! R = V-[1;0;0;1]*intensity;
%! assert(norm(R,inf), 0, 1e-9);
%!
%!test
